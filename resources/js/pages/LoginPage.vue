                ...
                <form @submit.prevent="handleLogin" class="space-y-4">
                    ...
                    <div class="flex gap-2">
                        <button
                            ...
                            class="flex-1 bg-gray-800 text-white py-2 rounded hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
                        ...
                        <button
                            type="button"
                            :disabled="authStore.loading"
                            class="flex-1 border border-gray-300 text-gray-700 py-2 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
